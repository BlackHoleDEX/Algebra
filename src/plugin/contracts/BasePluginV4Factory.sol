...
import './AlgebraBasePluginV4.sol';

/// @title Algebra Integral 1.2 default plugin factory
/// @notice This contract creates Algebra base plugins v4 for Algebra liquidity pools
/// @dev This plugin factory can only be used for Algebra base pools
contract BasePluginV4Factory is IBasePluginV4Factory {
  ...
  function _createPlugin(address pool) internal returns (address) {
    ...
    address plugin = address(new AlgebraBasePluginV4(pool, algebraFactory, address(this)));
