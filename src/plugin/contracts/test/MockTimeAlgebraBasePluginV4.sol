...
contract MockTimeAlgebraBasePluginV4 is AlgebraBasePluginV4 {
  using VolatilityOracle for VolatilityOracle.Timepoint[UINT16_MODULO];

  // Monday, October 5, 2020 9:00:00 AM GMT-05:00
  uint256 public time = 1601906400;

  constructor(address _pool, address _factory, address _pluginFactory) AlgebraBasePluginV4(_pool, _factory, _pluginFactory) {
    //
  }
