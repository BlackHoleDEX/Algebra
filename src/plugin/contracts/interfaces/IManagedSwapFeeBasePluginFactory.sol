...
/// @title The interface for the IManagedSwapFeeBasePluginFactory
/// @notice This contract creates Algebra default plugins for Algebra liquidity pools
interface IManagedSwapFeeBasePluginFactory is IAlgebraPluginFactory {
  ...
  /// @dev allows to change settings of plugin factory
